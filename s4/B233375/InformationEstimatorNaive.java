...
public class InformationEstimatorNaive implements InformationEstimatorInterface {
	...
	public static void main(String[] args) {
		InformationEstimatorNaive myObject;
		double value;
		debugMode = true;
		myObject = new InformationEstimatorNaive();
