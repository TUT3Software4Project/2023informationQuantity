...
public class Frequencer implements FrequencerInterface {
    ...
    public int frequency() {
        ...
        int targetLength = myTarget.length;//not set の場合は0になる?
        int spaceLength = mySpace.length;// not set の場合は0になる?
        ...
        //target ab(2) 
        for (int start = 0; start <= spaceLength- targetLength; start++) { // Is it OK? //開始地点(0文字目からtargetの最後がspaceの最後に一致するまで)
